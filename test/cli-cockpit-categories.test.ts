  ...
  const disabledReasonCases: readonly DisabledReasonCase[] = [
    ...
    },
    {
      ...
      disabled: [
        ...
        { id: 'install', disabled: 'Services stopped.' },
        { id: 'update', disabled: 'Services stopped.' },
        { id: 'test', disabled: 'Services stopped.' },
        { id: 'pot', disabled: 'Services stopped.' },
        { id: 'psql', disabled: 'Services stopped.' },
        { id: 'snapshot', disabled: 'Services stopped.' },
        { id: 'restore-snapshot', disabled: 'Services stopped.' },
        { id: 'resetdb', disabled: 'Services stopped.' },
      ],
      defaultChoice: 'start',
    },
    {
      ...
      sourceRepoCount: 1,
      disabled: [
        { id: 'install', disabled: 'Database not ready.' },
        { id: 'update', disabled: 'Database not ready.' },
        { id: 'test', disabled: 'Database not ready.' },
        { id: 'pot', disabled: 'Database not ready.' },
        { id: 'psql', disabled: 'Database not ready.' },
        { id: 'snapshot', disabled: 'Database not ready.' },
        { id: 'restore-snapshot', disabled: 'Database not ready.' },
        { id: 'resetdb', disabled: 'Database not ready.' },
      ],
      defaultChoice: 'start',
    },
    {
      ...
      disabled: [
        ...
        { id: 'install', disabled: 'Docker not running.' },
        { id: 'update', disabled: 'Docker not running.' },
        { id: 'test', disabled: 'Docker not running.' },
        { id: 'pot', disabled: 'Docker not running.' },
        { id: 'psql', disabled: 'Docker not running.' },
        { id: 'snapshot', disabled: 'Docker not running.' },
        { id: 'restore-snapshot', disabled: 'Docker not running.' },
        { id: 'resetdb', disabled: 'Docker not running.' },
      ],
