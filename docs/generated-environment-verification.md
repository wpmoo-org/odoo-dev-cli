...
| Module add/remove | Module skeleton files include manifest, model, access CSV, explicit view XML, action/menu XML, and selected source repo registration. Existing scaffold files are not overwritten. | `npx @wpmoo/toolkit add-module ...`, `npx @wpmoo/toolkit remove-module ...` |
